...
class CustomAnalogWatchStopWatch @JvmOverloads constructor(
    context: Context,
    ...
    private val dotCircleColor =
        resources.getColor(R.color.clock_dot_circle)// Replace with your desired dot circle color

    private val hourHandWidth = resources.getDimensionPixelSize(R.dimen.dp0).toFloat()
    private val minuteHandWidth = resources.getDimensionPixelSize(R.dimen.dp0).toFloat()
